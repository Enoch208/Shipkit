...
**Pipeline lives in [app/api/generate/route.ts](app/api/generate/route.ts)** — GitHub → Ace Chat → parallel fan-out to Suno / Midjourney / Luma. Helpers in [lib/](lib/). See [AGENTS.md](AGENTS.md) for conventions.
